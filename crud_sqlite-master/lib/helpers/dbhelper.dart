...
class DbHelper {
  ...
  void _createDb(Database db, int version) async {
    await db.execute('''CREATE TABLE contact (id INTEGER PRIMARY KEY AUTOINCREMENT,namalengkap TEXT,notelephone INTEGER,namaproject TEXT,progress TEXT,waktu TEXT)''');
  ...
  Future<List<Map<String, dynamic>>> select() async {
    ...
    var mapList = await db.query('contact', orderBy: 'namalengkap');
    return mapList;
  }
